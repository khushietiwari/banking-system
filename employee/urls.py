...
urlpatterns = [
    ...
    path('card-requests/', views.view_card_requests, name="view_card_requests"),
    path('card-update/<int:request_id>/<str:action>/', views.update_card_request, name="update_card_request"),
]
